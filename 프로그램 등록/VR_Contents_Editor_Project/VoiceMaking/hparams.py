...
basic_params.update({
    # Model
    'model_type': 'deepvoice', # [single, simple, deepvoice] # origin : deepvoice
...
if False: # Deep Voice 2 AudioBook Dataset
    ...
    basic_params.update({
        ...
        'attention_size': f(256), # origin : 128
...
basic_params.update({
    ...
    'initial_learning_rate': 0.002, #origin : 0.001
    ...
    # Eval
    'min_tokens': 30,#originally 50, 30 is good for korean, origin : 50
    'min_iters': 20, # origin : 30
    'max_iters': 200,
