...
class Synthesizer(object):
    ...
    def synthesize(self,
            ...
            librosa_trim=False,
            attention_trim=True, # origin : attention_trim=False
            isKorean=True):
...
def plot_graph_and_save_audio(args,
        ...
        librosa_trim=False, attention_trim=True, # origin : attention_trim=false
    ...
    if librosa_trim and end_of_sentence:
        yt, index = librosa.effects.trim(audio_out,
                frame_length=5120, hop_length=256, top_db=10) # origin top_db = 50
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_speakers', default=1, type=int) # origin : 1 해당 값을 바꿈으로써, 음성합설 할 때 교육중인 화자 인원 셋팅.
    parser.add_argument('--speaker_id', default=0, type=int) # origin : 0 해당 값을 바꿈으로써, 음성합성 화자 전환.
    ...
    audio = synthesizer.synthesize(
            ...
            attention_trim=True, # origin : false
