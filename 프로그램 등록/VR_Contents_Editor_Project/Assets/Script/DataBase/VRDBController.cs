...
public class VRDBController
{
    ...
    {
        GameDBController.DB_Name = "Assets/DataBase/TotalTable.sqlite";
    ...
    public static void Total_Delete(string s)
    {
        ...
        db.TotalDelete("DELETE FROM TotalTable WHERE SaveFile='" + s + "'");
    }
    ...
    public static void Init(string s)
    {
        ...
        arrSqls.Add("CREATE TABLE BigAnimation ( `Number` INTEGER , `BarX` REAL NOT NULL, `BarWidth` REAL NOT NULL, `AnimationName` TEXT NOT NULL, `HumanNumber` INTEGER NOT NULL,'AnimationText' TEXT NOT NULL, PRIMARY KEY(`Number`) )");
        ...
        arrSqls.Add("CREATE TABLE VoiceSmall('Number' INTEGER, 'HumanNumber' INTEGER NOT NULL,'VoiceGender' INTEGER NOT NULL,'VoiceName' TEXT NOT NULL, `BarX` REAL NOT NULL, `BarWidth` REAL NOT NULL, 'OriginNumber' INTEGER NOT NULL , PRIMARY KEY(`Number`))");
     ...
     *  
     **/
    public static void addBigActionInfo(int i, float _barX, float _barWidth, string _animationName, int _humanNumber, string _animationText)
    {
        DataTable dt = new DataTable();
        ...
        db.InsertData("INSERT INTO BigAnimation (Number,BarX,BarWidth,AnimationName,HumanNumber,AnimationText) VALUES(?,?, ?, ?, ?,?)", dt);
    ...
    public static void AddSmallVoiceInfo(int i, int _humanNumber, int _voiceGender, string _voiceName, float _barX, float _barWidth, int _originNumber)
    {
        DataTable dt = new DataTable();

        dt.Columns.Add(new DataColumn("Number", typeof(int)));
        dt.Columns.Add(new DataColumn("HumanNumber", typeof(int)));
        dt.Columns.Add(new DataColumn("VoiceGender", typeof(int)));
        dt.Columns.Add(new DataColumn("VoiceName", typeof(string)));
        dt.Columns.Add(new DataColumn("BarX", typeof(float)));
        dt.Columns.Add(new DataColumn("BarWidth", typeof(float)));
        dt.Columns.Add(new DataColumn("OriginNumber", typeof(int)));
        ...
        db.InsertData("INSERT INTO VoiceSmall (Number,HumanNumber,VoiceGender,VoiceName,BarX,BarWidth,OriginNumber) VALUES(?,?,?,?,?,?,?)", dt);
