...
public class AniBarCreate
{
    ...
    public AniBarCreate(GameObject go, GameObject go1, string str, int objectNum, int voice)
    {
        this._biggo = go;
        this._smallgo = go1;
...
public class HumanDelete
{
    ...
    public HumanDelete(int originNum, int objectNum, string humanName, Vector3 pos, Vector3 rot, Vector3 scale, List<AniBarDelete> A, List<AniBarVoiceDelete> AA)
    {
        this._originNum = originNum;
        this._objectNum = objectNum;
...
public class AniBarVoiceDelete
{
    ...
    private string _parentName;
    private int _voiceGender;
    private int _originNumber;

    public AniBarVoiceDelete(float barX, float barWidth, string voiceName, string parentName, int voiceGender, int originNumber)
    {
        _barX = barX;
        _barWidth = barWidth;
    ...
    public string GetParentName() { return _parentName; }
    public int GetVoiceGender() { return _voiceGender; }
    public int GetOriginNumber() { return _originNumber; }
}
public class DressChange
{
    ...
    public DressChange(string[] name, string prev, string objectName, int originNum, int objectNum)
    {
        _name = name;
        _prev = prev;
