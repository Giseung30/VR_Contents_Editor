...
*/
    ...
    {
        SkinnedMeshRenderer _colourizationSkin = _colourization.GetComponent<SkinnedMeshRenderer>();
        _colourizationSkin.material.color = new Color(_r.value / 255f, _g.value / 255f, _b.value / 255f, 40f / 255f); //메터리얼 색 변경W
    ...
    public void onShoseTookOff()
    {
        ...
        _clickedItemControl._clickedItem.item3d.transform.Find("shoes").GetChild(0).GetChild(0).gameObject.SetActive(true);
        Vector3 _pos = _clickedItemControl._clickedItem.item3d.transform.localPosition;
        //_pos.y = -0.1316523f;
        _clickedItemControl._clickedItem.item3d.transform.localPosition = _pos;
    }
}
