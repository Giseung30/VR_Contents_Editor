        ...
        if (_clickedItem._originNumber >= 2000 && _clickedItem._originNumber <= 2005) //즉 사람이면 스케줄러 삭제 실행
        {
            ...
            for (int i = 0; i < _itemListControl._dataBaseBigVoice.Count; i++)
            {
                try
                {
                    ...
                    abvd.Add(new AniBarVoiceDelete(_barX, _barWidth, _voiceName, _parentName,_voiceGender, _originNumber));
                }
                catch (Exception e)
                {
                    Debug.Log(e);
            ...
            HistoryController.pushHumanDeleteHist(_clickedItem._originNumber, _clickedItem._objectNumber, _clickedItem.itemName, _clickedItem.item3d.transform.parent.transform.position, _clickedItem.item3d.transform.parent.transform.eulerAngles, _clickedItem.item3d.transform.parent.transform.localScale, abd, abvd);
...
*/
    ...
    {
        HistoryController.pushObjectHist(_clickedItem.item3d.transform.parent.gameObject, _clickedItem.item3d.transform.parent.localPosition, _clickedItem.item3d.transform.parent.localScale, _clickedItem._objectNumber, _clickedItem._originNumber, _clickedItem.item3d.transform.rotation);
...
*/
    ...
    public void OnClickVoiceManMenuTag()
    {
        ...
        _searchInputField._itemContent = _manVoiceButtons;
    }
    ...
    public void OnClickVoiceWomanMenuTag()
    {
        ...
        _searchInputField._itemContent = _womanVoiceButtons;
    }
