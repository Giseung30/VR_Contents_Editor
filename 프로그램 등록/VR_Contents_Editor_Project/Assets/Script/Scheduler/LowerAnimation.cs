...
public class LowerAnimation : MonoBehaviour {
   ...
   */
    ...
    public void CreateAniBar(bool check)
    {
        ...
        HistoryController.pushAniBarCreateHist(_bigAniBar, _smallAniBar, this.gameObject.name, _clickedItemControl._clickedItem._objectNumber,1);
    }
