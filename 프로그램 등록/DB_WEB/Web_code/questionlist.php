...
$sql = "select * $sql_common order by qstn_grop_cd DESC limit $from_record, {$config['cf_page_rows']} ";
...
<div class="btn_fixed_top">
    <a href="./questionform.php" class="btn btn_01">검사지 추가</a>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mng td_mng_l">
            <a href="./questionform.php?w=u&amp;qstn_grop_cd=<?php echo $row['qstn_grop_cd']; ?>" class="btn btn_03"><span class="sound_only"></span>수정</a>
            <a href="./questiondetaillist.php?qstn_grop_cd=<?php echo $row['qstn_grop_cd']; ?>" class="btn btn_02"><span class="sound_only"></span>질문</a><br/>
			<a href="./replylist.php?qstn_grop_cd=<?php echo $row['qstn_grop_cd']; ?>" class="btn btn_02"><span class="sound_only"></span>결과</a>
			<!--
            <a href="./questionformupdate.php?w=d&amp;qstn_cd=<?php echo $row['qstn_cd']; ?>" onclick="return delete_confirm(this);" class="btn btn_02"><span class="sound_only"><?php echo htmlspecialchars2($row['co_subject']); ?> </span>삭제</a>
			-->
        </td>
    </tr>
    <?php
